...
class BitgetAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def _trade_update_event(self):
        resp = {
            "action": "update",
            "arg": {"instType": "SPOT", "channel": "trade", "instId": self.ex_trading_pair},
            "data": [
                {"ts": "1695709835822", "price": "26293.4", "size": "0.0013", "side": "buy", "tradeId": "1000000000"}
            ],
            "ts": 1695711090682,
        }
        return resp
    ...
    def _order_diff_event(self):
        resp = {
            "action": "update",
            "arg": {"instType": "SPOT", "channel": "books5", "instId": self.ex_trading_pair},
            "data": [
                {
    ...
    def test_get_new_order_book_successful(self, mock_api):
        ...
        expected_update_id = int(resp["data"]["ts"])

        self.assertEqual(expected_update_id, order_book.snapshot_uid)
        bids = list(order_book.bid_entries())
        asks = list(order_book.ask_entries())
        self.assertEqual(2, len(bids))
        self.assertEqual(34567, bids[0].price)
        self.assertEqual(0.2917, bids[0].amount)
        self.assertEqual(expected_update_id, bids[0].update_id)
        self.assertEqual(2, len(asks))
        self.assertEqual(34567.15, asks[0].price)
        self.assertEqual(0.0131, asks[0].amount)
    ...
    def test_listen_for_subscriptions_subscribes_to_trades_and_order_diffs(self, ws_connect_mock):
        ...
        result_subscribe_diffs = {
            "event": "subscribe",
            "arg": {"instType": "SPOT", "channel": "books", "instId": self.ex_trading_pair},
        }
        ...
        expected_trade_subscription = {
            "op": "subscribe",
            "args": [{"instType": "SPOT", "channel": "trade", "instId": self.ex_trading_pair}],
        }
        self.assertEqual(expected_trade_subscription, sent_subscription_messages[0])
        expected_diff_subscription = {
            "op": "subscribe",
            "args": [{"instType": "SPOT", "channel": "books", "instId": self.ex_trading_pair}],
        }
        self.assertEqual(expected_diff_subscription, sent_subscription_messages[1])

        self.assertTrue(self._is_logged("INFO", "Subscribed to public order book and trades channels..."))
    ...
    def test_listen_for_trades_cancelled_when_listening(self):
        ...
        self.data_source._message_queue[CONSTANTS.WS_SUBSCRIPTION_TRADES_CHANNEL_NAME] = mock_queue
    ...
    def test_listen_for_trades_successful(self):
        ...
        self.assertEqual(1000000000, msg.trade_id)

    def test_listen_for_order_book_diffs_cancelled(self):
        mock_queue = AsyncMock()
        mock_queue.get.side_effect = asyncio.CancelledError()
        self.data_source._message_queue[CONSTANTS.WS_SUBSCRIPTION_DIFF_CHANNEL_NAME] = mock_queue
    ...
    def test_listen_for_order_book_diffs_successful(self):
        ...
        self.assertEqual(int(diff_event["data"][0]["ts"]), msg.update_id)
    ...
    @aioresponses()
    @patch(
        "hummingbot.connector.exchange.bitget.bitget_api_order_book_data_source" ".BitgetAPIOrderBookDataSource._sleep"
    )
    ...
    def test_listen_for_order_book_snapshots_successful(
        ...
        self.assertEqual(1698303884584, msg.update_id)
